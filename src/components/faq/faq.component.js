...
export default class FAQ extends Component {
    ...
    render() {
        ...
        return(
            <div className="FAQ">
                <img className="logo_img-FAQ" src={logo} alt="search"></img>
                <h3>О сервисе</h3>
                <div className="faqText">
                   После активации аккаунта становится доступен просмотр и покупка прокси. Купленные прокси появляются в сплывающем окне и в разделе history в виде ip:port. IP будет нашего сервера, он может отличаться от страны прокси. Это бэкконект прокси, они работают через наш сервер, поэтому при работе вы будете иметь исходящий IP адрес, который вы покупали, а не нашего сервера. Нужно скопировать ip и port и без ошибок вставить их в ту программу, в которой прокси используется.
                </div>
                <br/>
                ...
                <div className="faqText">
                    Сортировка по умолчанию сделана так, что сначала выдаются прокси, которые покупают наиболее часто. 
                </div>
                <br/>
